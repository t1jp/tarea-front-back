...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <br />
    <asp:Label ID="lbl_nombre" runat="server" CssClass="badge" Text="Nombres"></asp:Label>
    <asp:TextBox ID="txt_nombre" runat="server" CssClass="form-control"></asp:TextBox>
    <asp:Label ID="lbl_apellido" runat="server" CssClass="badge" Text="Apellidos"></asp:Label>
    ...
    <asp:TextBox ID="txt_fn" runat="server" CssClass="form-control" TextMode="Date"></asp:TextBox>
        <asp:Label ID="lbl_fir" runat="server" CssClass="badge" Text="Fecha Ingreso Registro"></asp:Label>
    <asp:TextBox ID="txt_fir" runat="server" CssClass="form-control" TextMode="Date"></asp:TextBox>
    ...
    <asp:GridView ID="grid_empleados" runat="server" AutoGenerateColumns="False" CssClass="table-condensed" DataKeyNames="id,id_puesto" OnRowDeleting="grid_empleados_RowDeleting" OnSelectedIndexChanged="grid_empleados_SelectedIndexChanged">
        <Columns>
            ...
            <asp:BoundField DataField="fecha_ingreso_registro" DataFormatString="{0:d}" HeaderText="Ingreso_Registro" />
        </Columns>
    </asp:GridView>
</asp:Content>
